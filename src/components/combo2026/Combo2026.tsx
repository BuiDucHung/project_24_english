...
import combo from '../../../mock_api/dataCombbo2026.json'


const Combo2026: React.FC = () => {
  ...
  return (
    <div className={styles.course}>
      <Typography variant='h2' className={styles.course_title}>
        COMBO LUYỆN THI 2026 DÀNH CHO 2008
      </Typography>
            ...
            <React.Fragment>
              {breackpoin_mobile ? (
                <div className={`${styles.course_option__item} ${styles.mobile} ${Number(value) === 0 ? styles.mobile_active : ''}`}
                  onClick={() => setValue(0)}
                >
                  <Typography>PRO 3M - MỤC TIÊU 8+ (2026)</Typography>
            ...
            <React.Fragment>
              {breackpoin_mobile ? (
                <div className={`${styles.course_option__item} ${styles.mobile} ${Number(value) === 2 ? styles.mobile_active : ''}`}
                  onClick={() => setValue(2)}
                >
                  <Typography>PRO 3MPLUS - MỤC TIÊU 9+ (2026)</Typography>
                  <div className={styles.combo_mobile}>
                    <div className={styles.buy_combo}>
                      <Typography>
                        <span style={{ marginRight: 4 }}>
                    ...
                    <div className={styles.price}>
                      <Typography>6,900,000 VNĐ</Typography>
                      2,060,000 VNĐ
                    </div>
                  </div>
                </div>
